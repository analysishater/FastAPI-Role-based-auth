...
# git push -u origin main must be used for the first tima to tell the local folder  to push to the url called origin at the branch called main(then we can do git push after) in the remote method , cuz clone does all this automaticlly .
